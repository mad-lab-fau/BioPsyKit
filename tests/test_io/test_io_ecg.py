...
def hr_subject_dict_none():
    return None


def hr_subject_dict_wrong_col_name():
    phases = ["phase1", "phase2", "phase3"]
...
def hr_subject_dict_too_many_columns():
    phases = ["phase1", "phase2", "phase3"]
...
def hr_subject_dict_wrong_col_index():
    phases = ["phase1", "phase2", "phase3"]
    df = pd.DataFrame(
...
def hr_subject_dict_wrong_index_name():
    phases = ["phase1", "phase2", "phase3"]
...
def hr_subject_dict_wrong_index_levels():
    phases = ["phase1", "phase2", "phase3"]
...
class TestIoEcg:
    @pytest.mark.parametrize(
        "input_data, expected",
        [
            (hr_subject_dict_none(), pytest.raises(ValidationError)),
            (hr_subject_dict_wrong_col_name(), pytest.raises(ValidationError)),
            (hr_subject_dict_too_many_columns(), pytest.raises(ValidationError)),
            (hr_subject_dict_wrong_col_index(), pytest.raises(ValidationError)),
            (hr_subject_dict_wrong_index_name(), pytest.raises(ValidationError)),
            (hr_subject_dict_wrong_index_levels(), pytest.raises(ValidationError)),
            (hr_subject_dict_correct(), does_not_raise()),
        ],
        ids=[
            "none",
            "wrong_col_names",
    ...
    @pytest.mark.parametrize(
        "input_data, expected",
        [
            (hr_subject_dict_none(), False),
            (hr_subject_dict_wrong_col_name(), False),
            (hr_subject_dict_too_many_columns(), False),
            (hr_subject_dict_wrong_col_index(), False),
            (hr_subject_dict_wrong_index_name(), False),
            (hr_subject_dict_wrong_index_levels(), False),
            (hr_subject_dict_correct(), True),
        ],
        ids=[
            "none",
            "wrong_col_names",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("load_hr_subject_dict_folder", "hr_result_(\w+).xlsx", does_not_raise()),
            ("load_hr_subject_dict_folder", "ecg_result.xlsx", pytest.raises(FileNotFoundError)),
            ("test", "hr_result_(\w+).xlsx", pytest.raises(FileNotFoundError)),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("load_hr_subject_dict_folder", "hr_result_(\w+).xlsx", "Vp*", does_not_raise()),
