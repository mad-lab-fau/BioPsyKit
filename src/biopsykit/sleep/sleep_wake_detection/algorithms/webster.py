...
class Webster(_SleepWakeBase):
    ...
    def __init__(self, **kwargs):
        ...
        The *Webster Algorithm* runs sleep wake detection on epoch level activity data. Epochs are 1 minute
        ...
        """
        scale_factor = kwargs.get("scale_factor", 0.025)
    ...
    def predict(self, data: arr_t, **kwargs) -> SleepWakeDataFrame:
        ...
        **kwargs :
        ...
        epoch_length: int = kwargs.get("epoch_length", 60)
